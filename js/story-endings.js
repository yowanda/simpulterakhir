...
const ENDING_REQUIREMENTS = {
  1:  { rating: 'S', title: 'Sang Penenun Terakhir', hint: 'Eliminasi SEMUA killer, kumpulkan 5+ petunjuk, 4+ survivor hidup, moral positif.' },
  2:  { rating: 'S', title: 'Detektif Sejati', hint: 'Eliminasi SEMUA killer, temukan SEMUA 8 petunjuk pelarian.' },
  3:  { rating: 'A', title: 'Fajar yang Cukup', hint: 'Eliminasi SEMUA killer, kumpulkan 2-4 petunjuk, 2+ survivor hidup.' },
  4:  { rating: 'A', title: 'Pengorbanan', hint: 'Player mati, tapi 3+ survivor selamat dan 3+ petunjuk terkumpul.' },
  5:  { rating: 'A', title: 'Kesaksian Terakhir', hint: 'Vira hidup, 4+ survivor selamat, menang lewat pelarian atau eliminasi killer.' },
  6:  { rating: 'B', title: 'Abu dan Fajar', hint: 'SEMUA killer mati, tapi 3+ petunjuk dihancurkan, petunjuk < 5.' },
  7:  { rating: 'B', title: 'Kemenangan yang Pecah', hint: 'SEMUA killer mati, tapi 3+ kematian terjadi, survivor tersisa <= 3.' },
  8:  { rating: 'B', title: 'Penebusan Penulis', hint: 'Lana (killer) mati, moral positif. Lana memilih penebusan.' },
  9:  { rating: 'B', title: 'Lingkaran Vira', hint: 'Vira hidup, 3+ survivor selamat, player bukan Vira.' },
  10: { rating: 'C', title: 'Kemenangan Pyrrhic', hint: 'SEMUA killer mati, tapi petunjuk < 3. Sang Penenun lolos.' },
  11: { rating: 'C', title: 'Perjanjian dengan Iblis', hint: '8+ karakter hidup, tapi moral sangat rendah (< -5).' },
  12: { rating: 'C', title: 'Perpecahan Fatal', hint: '2-4 survivor selamat, game berakhir saat fajar tanpa resolusi.' },
  13: { rating: 'C', title: 'Warisan Wardhana', hint: 'Niko hidup dan BUKAN killer. Pewaris yang memilih sisi benar.' },
  14: { rating: 'D', title: 'Paranoia Menang', hint: 'Rata-rata trust < 25, 2+ kematian terjadi. Kepercayaan runtuh total.' },
  15: { rating: 'D', title: 'Tuduhan Salah', hint: 'Killer masih hidup, Sera hidup, killer menang. Salah tuduh.' },
  16: { rating: 'D', title: 'Sang Penenun Menang', hint: 'Player hidup, tapi killer menang. Siklus berlanjut.' },
  17: { rating: 'D', title: 'Pengkhianatan Dokter', hint: 'Dimas (killer) hidup, killer menang atau player kalah.' },
  18: { rating: 'F', title: 'Simpul Terputus Total', hint: 'Player hidup tapi sendirian, 5+ kematian. Hampir semua mati.' },
  21: { rating: 'B', title: 'Pahlawan yang Jatuh', hint: 'Player (Arya) mati, tapi 2+ survivor selamat. Mati sebagai pahlawan.' },
  22: { rating: 'D', title: 'Siklus Berlanjut', hint: 'Player hidup, petunjuk <= 1, masih chapter awal (1-3).' },
  23: { rating: 'C', title: 'Plot Twist Penulis', hint: 'Lana (killer) selamat, identitas tersembunyi, player tidak menang.' },
  24: { rating: 'C', title: 'Profiler dan Subjek', hint: 'Sera hidup, game berakhir saat fajar. Profiling dimanfaatkan musuh.' },
  25: { rating: 'F', title: 'Mayoritas yang Diam', hint: '7+ karakter hidup, moral sangat rendah (< -10). Semua memilih diam.' },
  26: { rating: 'S', title: 'Pelarian dari Mansion', hint: 'Kumpulkan 5+ petunjuk atau temukan Kunci Master, player hidup, menang lewat pelarian.' },
  27: { rating: 'S', title: 'Pembantai Pembunuh', hint: 'SEMUA killer dieliminasi lewat combat, 3+ survivor hidup.' },
  28: { rating: 'A', title: 'Pengkhianatan Sempurna', hint: '2+ killer, SEMUA killer mati, ada killer yang saling bunuh (betrayal).' },
  29: { rating: 'D', title: 'Jejak yang Terhapus', hint: 'Killer menghancurkan cukup petunjuk sehingga pelarian mustahil.' },
  30: { rating: 'A', title: 'Yang Terakhir Berdiri', hint: 'SEMUA killer mati, tapi hanya 1 survivor tersisa. Kemenangan sendirian.' }
};
