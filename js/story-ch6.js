...
'ch6_start': {
  ...
  text: (s) => {
    ...
    if (pc !== 'juno') {
      ...
      text += `<p><span class="speaker juno">Juno</span> Lo ambil pipa besi dari tumpukan puing. "Gue ikut." Lo nggak peduli rencana — lo cuma tahu lo nggak bisa diam.</p>`;
    }
    if (pc !== 'farah') {
...
'ch6_final_descent': {
  text: (s) => {
    let text = `<p><span class="speaker sera">Sera</span> Kau turun ke B-3 untuk terakhir kalinya. Di belakangmu: `;
    ...
    text += `<p><span class="speaker sera">Sera</span> B-3. Apartemen bawah tanah Ragil Pramudya. Monitor-monitor masih menyala — atau sudah diganti.</p>`;
...
'ch6_burn_mansion': {
  text: (s) => {
    ...
    text += `<p><span class="speaker lana">Lana</span> Wine cellar di basement. Puluhan botol alkohol berkadar tinggi. Kain. Korek api dari dapur.</p>`;
    text += `<p><span class="speaker lana">Lana</span> Kau memulai dari B-2 — ruang server. Api menyala cepat di udara kering bawah tanah. Menjalar ke kabel, ke kertas, ke kayu tua.</p>`;
    text += `<p><span class="speaker lana">Lana</span> Alarm kebakaran berbunyi — tapi tidak ada pemadam. Mansion ini di tengah hutan. Bantuan terdekat dua jam jauhnya.</p>`;
    text += `<p><span class="speaker lana">Lana</span> Semua berlari ke atas. Api mengikuti — naik melalui ventilasi, melalui lorong-lorong yang menjadi cerobong asap.</p>`;
...
'ch6_fire_escape': {
  text: (s) => {
    let text = `<p><span class="speaker lana">Lana</span> Api bergerak lebih cepat dari yang kau perkirakan. Dinding kayu tua menjadi bahan bakar sempurna. Asap mengisi lorong seperti air mengisi kapal tenggelam.</p>`;
    text += `<p class="sound">— Kau memimpin evakuasi — pintu depan, jendela, apapun yang terbuka. —</p>`;

    if (s.flags.hasMasterKey && !s.flags.usedKeyEarly) {
      text += `<p class="sound">— Kunci master. Sekarang. Kau memasukkannya ke pintu utama. Memutar. Klik berat. —</p>`;
      text += `<p><span class="speaker lana">Lana</span> Pintu terbuka. Udara malam menyerbu masuk — dan menambah oksigen untuk api di belakang.</p>`;
      text += `<p><span class="speaker lana">Lana</span> "KELUAR! SEMUA KELUAR!"</p>`;
    } else {
      text += `<p><span class="speaker juno">Juno</span> Jendela lantai satu — yang sudah retak dari usaha Juno tadi — kali ini menyerah. Api melemahkan segel-nya. Kaca pecah.</p>`;
      text += `<p><span class="speaker juno">Juno</span> Satu per satu, kalian memanjat keluar melalui jendela yang pecah, melalui pecahan kaca dan asap.</p>`;
    }

    text += `<p><span class="speaker juno">Juno</span> Di luar, kalian berlari. Hutan pinus menangkap sedikit percikan api tapi hujan ringan yang mulai turun menahan penyebaran.</p>`;
    text += `<p><span class="speaker juno">Juno</span> Dari kejauhan, mansion Wardhana terbakar. Lima puluh tahun sejarah gelap menjadi pilar api yang menerangi langit malam.</p>`;
...
'ch6_ragil_fire': {
  text: `<p><span class="speaker juno">Juno</span> Kau turun ke B-3 melawan arus asap. Paru-parumu memprotes. Matamu berair. Tapi kau turun.</p>
<p><span class="speaker juno">Juno</span> Ragil masih di kursi rodanya. Api belum sampai di sini — tapi asap sudah. Dia batuk-batuk, lemah.</p>
<p><span class="speaker juno">Juno</span> "Kau..." dia melihatmu melalui air mata dan asap, "...kau datang menyelamatkanku?"</p>
<p><span class="speaker juno">Juno</span> "Bukan. Aku datang memastikan kau menghadapi konsekuensi. Bukan mati terbakar sendirian — tapi hidup dan diadili."</p>
<p><span class="speaker juno">Juno</span> "Tidak ada pengadilan yang bisa menghukumku. Aku sudah sekarat."</p>
<p><span class="speaker juno">Juno</span> "Tapi ada publik. Ada internet. Ada cerita. Dan aku SANGAT pandai bercerita."</p>
<p class="sound">— Kau mendorong kursi rodanya ke tangga. Naik. Satu level. Dua. Tiga. —</p>
<p class="sound">— Api sudah di B-1 saat kalian sampai di lantai satu. Panas. Asap pekat. —</p>
<p class="sound">— Pintu keluar — terbuka. Seseorang sudah membukanya dari luar. —</p>
<p><span class="speaker juno">Juno</span> Kau mendorong Ragil keluar. Udara malam menghantam. Batuk yang tidak berhenti selama menit-menit yang terasa seperti jam.</p>`,
  shake: true,
  choices: [
    {
